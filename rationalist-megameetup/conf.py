...
BLOG_AUTHOR = "Michael Tartre"  # (translatable)
BLOG_TITLE = "NYC Rationalist Megameetup"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://rationalistmegameetup.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://rationalistmegameetup.com/"
BLOG_EMAIL = "rationalist.megameetup@gmail.com"
BLOG_DESCRIPTION = "Homepage for information and registration for the NYC Rationalist Megameetup."  # (translatable)
